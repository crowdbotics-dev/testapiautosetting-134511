...
class Testconnectors134511ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134511_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134511_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134511"
